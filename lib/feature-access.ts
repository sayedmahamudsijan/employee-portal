...
export const FEATURES = [
  ...
  { key: "design",           label: "Portal Design Studio" },
  { key: "send_invitation",  label: "Send Invitations" },
  { key: "approve_employee", label: "Approve Employees" },
] as const;
...
export const DEFAULT_FEATURE_ACCESS: Record<FeatureKey, Role[]> = {
  ...
  history:          ["CEO", "CMO", "CTO"],
  design:           ["CEO", "CMO", "CTO"],
  send_invitation:  ["ADMIN", "CEO", "CMO", "CTO"],
  approve_employee: ["ADMIN", "CEO", "CMO", "CTO"],
};
